  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `player_stats` (`id` INTEGER NOT NULL, `totalGames` INTEGER NOT NULL, `arcadeBest` INTEGER NOT NULL, `timedBest` INTEGER NOT NULL, `duelBest` INTEGER NOT NULL, `duelWins` INTEGER NOT NULL, `duelLosses` INTEGER NOT NULL, `updatedAt` INTEGER NOT NULL, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'ac96ca63232f9c6c746682cf4f4f1e19')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsPlayerStats = new HashMap<String, TableInfo.Column>(8);
        ...
        _columnsPlayerStats.put("duelBest", new TableInfo.Column("duelBest", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "ac96ca63232f9c6c746682cf4f4f1e19", "26ac5d97789b63a4d9230153717cac43");
