...
public final class PlayerStatsDao_Impl implements PlayerStatsDao {
  ...
  public PlayerStatsDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfPlayerStats = new EntityInsertionAdapter<PlayerStats>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `player_stats` (`id`,`totalGames`,`arcadeBest`,`timedBest`,`duelBest`,`duelWins`,`duelLosses`,`updatedAt`) VALUES (?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(5, entity.duelBest);
        statement.bindLong(6, entity.duelWins);
        statement.bindLong(7, entity.duelLosses);
  ...
  public PlayerStats getStats() {
    ...
    try {
      ...
      final int _cursorIndexOfDuelBest = CursorUtil.getColumnIndexOrThrow(_cursor, "duelBest");
      ...
      if (_cursor.moveToFirst()) {
        ...
        _result.duelBest = _cursor.getInt(_cursorIndexOfDuelBest);
