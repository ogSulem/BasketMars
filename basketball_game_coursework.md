...
5. Реализовать систему достижений с разблокируемым инвентарем (мячи, сетки, фоны).
...
|---|---|---|
| NBA 2K Mobile | Официальная лицензия NBA, 3D-графика | Платная, тяжелая, требует интернет |
...
Приложение спроектировано по **многослойной (Layered) архитектуре**, разделенной на четыре слоя:
...
- **Темная тема** (Dark Theme) — фиолетово-черная палитра (#1A102B / #8f5cff)
...
| Сценарий | Результат |
|---|---|
| Бросок попадает в кольцо | Счет +1, кольцо перемещается, анимация сетки |
| Бросок мимо кольца | Счет без изменений, мяч возвращается |
...
Проект демонстрирует, что полнофункциональная мобильная игра может быть создана средствами нативного Android SDK без зависимости от тяжелых игровых движков — при правильной архитектуре и тщательном проектировании.
